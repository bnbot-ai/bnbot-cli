...
export declare function jikeSearchCommand(query: string, options: {
    limit?: string;
}): Promise<void>;
export declare function xiaohongshuSearchCommand(query: string, options: {
    limit?: string;
}): Promise<void>;
...
export declare function linkedinSearchCommand(query: string, options: {
    limit?: string;
}): Promise<void>;
...
export declare function yahooFinanceQuoteCommand(symbol: string): Promise<void>;
//# sourceMappingURL=scraperActions.d.ts.map